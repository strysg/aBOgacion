...
Ley de Electricidad. Es la [Ley de Electricidad](#TODO-link) Número 1604 de 21 de diciembre de 1994.
...
## Capítulo II El comite nacional de despacho de carga
...
Los Distribuidores, que en base a lo dispuesto por el artículo 15 de la [Ley de Electricidad](#TODO-link) sean propietarios de instalaciones de Generación, solo participarán en la designación del miembro representante de las empresas de Distribución.
...
## Capítulo III El mercado electrico mayorista
...
**Artículo 11°.- (CONTRATOS DE LOS DISTRIBUIDORES)** Un Distribuidor debe contratar con los Generadores el abastecimiento de su demanda en uno o más nodos de suministro, respetando las restricciones de la [Ley de Electricidad](#TODO-link) y el presente Reglamento. Los contratos de abastecimiento serán pactados libremente en cuanto a las cantidades de energía y Potencia de Punta contratadas con cada Generador.
...
## Capítulo IV Obligaciones y derechos de los agentes del mercado
...
13. Acatar todas las reducciones en su remuneración, que la [Ley de Electricidad](#TODO-link) y sus reglamentos establezcan.
...
## Capítulo V Programacion de la operacion y despacho de carga en el mercado
...
7. El parque de generación y transmisión, de acuerdo a las pautas establecidas en el [Reglamento de Precios y Tarifas](#TODO-link) de la Ley de Electricidad. CONSIDERANDO además los contratos de importación vigentes como oferta adicional; y,
...
**Artículo 32°.- (CALCULO DE LOS COSTOS MARGINALES DE CORTO PLAZO DE ENERGIA ESPERADOS)** En base a los resultados de los respectivos modelos, el Comité determinará los Costos Marginales de Corto Plazo de Energía Esperados para cada semana dentro de los bloque horarios establecidos, de acuerdo a las normas correspondientes del [Reglamento de Precios y Tarifas](#TODO-link) de la Ley de Electricidad.

**Artículo 33°.- (INFORMES DE LA PROGRAMACION DE MEDIANO PLAZO)** A más tardar el 15 de marzo y el 15 de septiembre de cada año el Comité pondrá en conocimiento de la Superintendencia y los Agentes del Mercado la programación de mediano plazo con los datos contenidos en el informe preliminar de Precios de Nodo, que se indica en el artículo 19 del [Reglamento de Precios y Tarifas](#TODO-link) de la Ley de Electricidad, más los siguientes resultados previstos de la operación del Mercado:
...
## Capítulo VII Costos marginales por nodo
...
## Capítulo VIII Transacciones en el mercado spot
...
1. Para las centrales hidráulicas:
   ...
   ![$POTMES_c = PFG_c \cdot PNP_n_n](#TODO-link)
2. Para las Unidades Generadoras térmicas no penalizadas:
     
   ![$POTMES_q_2 = PFG_q_2 \cdot (PNP_n + $ADIC)](#TODO-link)
3. Para las Unidades Generadoras térmicas penalizadas:
     
   ![$POTMES_q_1=(1 - %PEN) \cdot PFG_q_1 - PNP_n](#TODO-link)
...
![%PEN = \text{m\acute{a}ximo de }(INDMES_q -INDO, 0)](#TODO-link)
...
![$ADIC = E(%PE_q_1\cdot PFG_q_1\cdot PNP_n)\\E(PFG_q_2)](#TODO-link)
...
## Capítulo IX Remuneracion del sistema troncal de interconexion
...
## Capítulo X Transacciones comerciales
...
## Capítulo XI Recurso de revocatoria y jerarquico
...
Reglamento Anexo al [Decreto Supremo Nº 24043](#TODO-link), promulgado a los veintiocho días del mes de junio de mil novecientos noventa y cinco años.
