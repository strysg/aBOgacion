...
* Que el Artículo 7 del Reglamento General a la [Ley Nº 164](#TODO-link) de 8 de agosto de 2011 General de Telecomunicaciones, Tecnologías de Información y Comunicación, para el Sector de Telecomunicaciones, aprobado a través del [Decreto Supremo Nº 1391](#TODO-link) de 24 de octubre de 2012, dispone que el Plan Nacional de Frecuencias - PNF establece la atribución de las bandas de frecuencias del espectro radioeléctrico en el Estado Plurinacional de Bolivia entre los diferentes tipos de servicios de radiocomunicaciones.
