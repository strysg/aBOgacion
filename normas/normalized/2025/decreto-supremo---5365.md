...
* Que el Artículo 16 de la [Constitución Política del Estado](#TODO-link) determina que toda persona tiene derecho al agua y a la alimentación; y que el Estado tiene la obligación de garantizar la seguridad alimentaria, a través de una alimentación sana, adecuada y suficiente para toda la población.
...
* Que el numeral 7 del Artículo 407 de la [Constitución Política del Estado](#TODO-link) dispone que es objetivo de la política de desarrollo rural integral del Estado, en coordinación con las entidades territoriales autónomas y descentralizadas, promover sistemas de riego, con el fin de garantizar la producción agropecuaria.
